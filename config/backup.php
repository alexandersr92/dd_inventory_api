...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             * En producción, define BACKUP_DISK=s3 (o backblaze) para enviar los
             * respaldos fuera del servidor. En local cae a 'local'.
             */
            'disks' => [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'soporte@diplebill.com'),
